...
func TestGeneratePublishesSelectedPairUnderEveryInstalledLocalization(t *testing.T) {
	gameRoot := t.TempDir()
	...
	if result.LocalizationTargets != 3 {
		t.Fatalf("LocalizationTargets = %d, want 3", result.LocalizationTargets)
	}
