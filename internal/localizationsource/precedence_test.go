...
func TestResolveFromModsRootFailsClosedForLocalizationModWithoutExplicitModID(t *testing.T) {
	modsRoot := t.TempDir()
	...
	for _, want := range []string{"generated-id", "omits <modid>", "auto-generate"} {
